...
function productsFromCategoriesAndQueryCallback({ results }) {
...
export async function getProductsFromCategoryAndQuery(categoryId, query) {
  ...
  return customFetch(
    PRODUCTS_FROM_CATEGORIES_ENDPOINT, productsFromCategoriesAndQueryCallback,
  );
}
...
export async function getProductsByQuery(query) {
  ...
  return customFetch(
    PRODUCTS_FROM_QUERY_ENDPOINT, productsFromCategoriesAndQueryCallback,
  );
}
